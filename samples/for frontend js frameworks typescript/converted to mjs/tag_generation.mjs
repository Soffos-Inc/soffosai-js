...
let response = await service.call("Client 12345", "The Matrix is a 1999 science fiction action film written and directed by the Wachowskis. \
    It is the first installment in The Matrix film series...", ["topic", "domain", "audience", "entity"], 5);
