...
let response = await service.call("client12345", "How would Soffos SDK help me as a programmer?", "The Soffos SDK simplifies the process of plugging Soffos APIs into your applications. \
