...
var LanguageDetectionService = /*#__PURE__*/function (_SoffosAIService) {
  ...
  var _super = _createSuper(LanguageDetectionService);
  function LanguageDetectionService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, LanguageDetectionService);
    var service = _constants.ServiceString.LANGUAGE_DETECTION;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.LanguageDetectionIO();
    return _this;
  }
  ...
  _createClass(LanguageDetectionService, [{
    ...
    value: function call(user, text) {
      ...
      return _get(_getPrototypeOf(LanguageDetectionService.prototype), "call", this).call(this, payload);
    }
  }]);
  return LanguageDetectionService;
}(_service.SoffosAIService);
var _default = LanguageDetectionService;
