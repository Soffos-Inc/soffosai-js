...
var SoffosAIService = /*#__PURE__*/function () {
  ...
  function SoffosAIService(service) {
    ...
    var apikey = kwargs.apikey;
    this.headers = {
      "x-api-key": apikey || _app.apiKey
    };
  ...
  _createClass(SoffosAIService, [{
    ...
    value: function validatePayload() {
      var _this = this;
      if (!(0, _type_classifications.isDictObject)(this._payload)) {
        throw new TypeError("payload should be an object");
      }

      // Check for missing arguments
      var userFromSrc = this._payload.user;
      if (!userFromSrc) {
        return [false, "".concat(this._service, ": user key is required in the payload")];
      }
      if (this._serviceio.required_input_fields.length > 0) {
        var missingRequirements = this._serviceio.required_input_fields.filter(function (required) {
          return !(required in _this._payload);
        });
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var foundChoices = group.filter(function (choice) {
              return choice in _this._payload;
            });
      ...
      var inputStructure = this._serviceio.input_structure;
      var valueErrors = [];
      for (var _i = 0, _Object$entries = Object.entries(this._payload); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
          key = _Object$entries$_i[0],
          value = _Object$entries$_i[1];
        if (key in inputStructure) {
          var serviceioType = (0, _type_classifications.get_serviceio_datatype)(inputStructure[key]);
          var inputType = (0, _type_classifications.get_userinput_datatype)(value);
          if (inputType !== serviceioType) {
            var wrongType = value instanceof Object ? _typeof(value) : _typeof(value);
            valueErrors.push("".concat(key, " requires ").concat(inputType, " but ").concat(wrongType, " is provided."));
          }
        }
      }
      ...
      if ("document_ids" in this._payload) {
        var documentIds = this._payload.document_ids;
        if (Array.isArray(documentIds)) {
          var _iterator2 = _createForOfIteratorHelper(documentIds),
            _step2;
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var _id = _step2.value;
              var validUuid = isValidUuid(_id);
              if (!validUuid) {
                return [false, "".concat(_id, " is an invalid document_id")];
              }
            }
          } catch (err) {
            _iterator2.e(err);
    ...
    value: function getData() {
      var requestData = {};
      for (var _i2 = 0, _Object$entries2 = Object.entries(this._payload); _i2 < _Object$entries2.length; _i2++) {
    ...
    key: "getResponse",
    value: function () {
      var _getResponse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var payload,
          _this$validatePayload,
          _this$validatePayload2,
          allowInput,
          message,
          response,
          data,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _this$validatePayload = this.validatePayload(), _this$validatePayload2 = _slicedToArray(_this$validatePayload, 2), allowInput = _this$validatePayload2[0], message = _this$validatePayload2[1];
            ...
            case 18:
              ...
              Object.keys(data).forEach(function (key) {
                if (key == 'file') {
                  formData.append(key, (0, _fs.createReadStream)(data[key]));
                } else {
                  formData.append(key, data[key]);
                }
              });
              _headers = formData.getHeaders();
              _headers["x-api-key"] = this._apikey;
              _context.next = 24;
    ...
    value: function call() {
      ...
      return this.getResponse(_objectSpread(_objectSpread({}, this._argsDict), kwargs));
    }
  }, {
    key: "toString",
