 ...
 */
var SimplifyService = /*#__PURE__*/function (_SoffosAIService) {
  _inherits(SimplifyService, _SoffosAIService);
  var _super = _createSuper(SimplifyService);
  function SimplifyService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, SimplifyService);
    var service = _constants.ServiceString.SIMPLIFY;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.SimplifyIO();
    return _this;
  }
  ...
  _createClass(SimplifyService, [{
    ...
    value: function call(user, text) {
      ...
      return _get(_getPrototypeOf(SimplifyService.prototype), "call", this).call(this);
    }
  }]);
  return SimplifyService;
}(_service.SoffosAIService);
var _default = SimplifyService;
