...
var ProfanityService = /*#__PURE__*/function (_SoffosAIService) {
  ...
  var _super = _createSuper(ProfanityService);
  function ProfanityService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ProfanityService);
    var service = _constants.ServiceString.PROFANITY;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.ProfanityIO();
    return _this;
  }
