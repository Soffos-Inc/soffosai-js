...
var LanguageDetectionNode = /*#__PURE__*/function (_Node) {
  ...
  function LanguageDetectionNode(name, text) {
    var _this;
    _classCallCheck(this, LanguageDetectionNode);
    var service = new _app.LanguageDetectionService();
    var source = {
      text: text
    };
    return _possibleConstructorReturn(_this, _this = _super.call(this, name, service, source));
  }
  return _createClass(LanguageDetectionNode);
}(_node.Node);
var _default = LanguageDetectionNode;
