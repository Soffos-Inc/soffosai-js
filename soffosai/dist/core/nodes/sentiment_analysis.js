 ...
 */
var SentimentAnalysisNode = /*#__PURE__*/function (_Node) {
  _inherits(SentimentAnalysisNode, _Node);
  var _super = _createSuper(SentimentAnalysisNode);
  /**
   * @param {string} name
   * @param {string} text
   ...
   */
  function SentimentAnalysisNode(name, text) {
    var _this;
    ...
    _classCallCheck(this, SentimentAnalysisNode);
    var service = new _app.SentimentAnalysisService();
    var source = {
      text: text,
  ...
  return _createClass(SentimentAnalysisNode);
}(_node.Node);
var _default = SentimentAnalysisNode;
