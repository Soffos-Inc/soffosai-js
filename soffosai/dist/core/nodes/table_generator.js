...
var TableGeneratorNode = /*#__PURE__*/function (_Node) {
  ...
  function TableGeneratorNode(name, text) {
    ...
    _classCallCheck(this, TableGeneratorNode);
    var service = new _app.TableGeneratorService();
    var source = {
      text: text,
  ...
  return _createClass(TableGeneratorNode);
}(_node.Node);
var _default = TableGeneratorNode;
