...
var LogicalErrorDetectionNode = /*#__PURE__*/function (_Node) {
  ...
  function LogicalErrorDetectionNode(name, text) {
    var _this;
    _classCallCheck(this, LogicalErrorDetectionNode);
    var service = new _app.LogicalErrorDetectionService();
    var source = {
      text: text
    };
    return _possibleConstructorReturn(_this, _this = _super.call(this, name, service, source));
  }
  return _createClass(LogicalErrorDetectionNode);
}(_node.Node);
var _default = LogicalErrorDetectionNode;
