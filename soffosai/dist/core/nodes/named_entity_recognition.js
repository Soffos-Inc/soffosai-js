...
var NamedEntityRecognitionNode = /*#__PURE__*/function (_Node) {
  ...
  function NamedEntityRecognitionNode(name, text) {
    ...
    _classCallCheck(this, NamedEntityRecognitionNode);
    var service = new _app.NamedEntityRecognitionService();
    var source = {
      text: text
    };
  ...
  return _createClass(NamedEntityRecognitionNode);
}(_node.Node);
var _default = NamedEntityRecognitionNode;
