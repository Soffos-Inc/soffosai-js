...
var ContradictionDetectionNode = /*#__PURE__*/function (_Node) {
  ...
  function ContradictionDetectionNode(name, text) {
    var _this;
    _classCallCheck(this, ContradictionDetectionNode);
    var service = new _app.ContradictionDetectionService();
    var source = {
      text: text
    };
    return _possibleConstructorReturn(_this, _this = _super.call(this, name, service, source));
  }
  return _createClass(ContradictionDetectionNode);
}(_node.Node);
var _default = ContradictionDetectionNode;
