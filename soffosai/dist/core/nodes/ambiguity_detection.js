 ...
 */
var AmbiguityDetectionNode = /*#__PURE__*/function (_Node) {
  _inherits(AmbiguityDetectionNode, _Node);
  var _super = _createSuper(AmbiguityDetectionNode);
  /**
   ...
   */
  function AmbiguityDetectionNode(name, text) {
    var _this;
    ...
    _classCallCheck(this, AmbiguityDetectionNode);
    var service = new _app.AmbiguityDetectionService();
    var source = {
      text: text,
  ...
  return _createClass(AmbiguityDetectionNode);
}(_node.Node);
var _default = AmbiguityDetectionNode;
