...
var TranscriptCorrectionNode = /*#__PURE__*/function (_Node) {
  ...
  function TranscriptCorrectionNode(name, text) {
    var _this;
    _classCallCheck(this, TranscriptCorrectionNode);
    var service = new _app.TranscriptCorrectionService();
    var source = {
      text: text
    };
    return _possibleConstructorReturn(_this, _this = _super.call(this, name, service, source));
  }
  return _createClass(TranscriptCorrectionNode);
}(_node.Node);
var _default = TranscriptCorrectionNode;
